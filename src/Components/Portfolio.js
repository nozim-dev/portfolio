...
import portfolioImage1 from "./image/portfolioImage1.png";
import portfolioImage2 from "./image/portfolioImage2.png";
import portfolioImage3 from "./image/portfolioImage3.png";
import portfolioImage4 from "./image/portfolioImage4.png";
import portfolioImage5 from "./image/portfolioImage5.png";
import portfolioImage6 from "./image/portfolioImage6.png";
    ...
    <div className="portfolio">
      ...
      <div className="portfolio_row">
        ...
        <div className="portfolio_row_col">
          ...
          <h1>product tag mockup</h1>
        </div>
        <div className="portfolio_row_col">
          <div className="portfolio_row_col_image">
            <img src={portfolioImage5} alt="" />
          </div>
          <h1>perfume brand identity</h1>
        </div>
        <div className="portfolio_row_col">
          <div className="portfolio_row_col_image">
      ...
      {/* Quote Block starting */}
      <div className="qoutte_block">
        <div className="qoutte_block_item">
          <img src={Vector1} alt="" />
        </div>
        <div className="qoutte_block_item">
